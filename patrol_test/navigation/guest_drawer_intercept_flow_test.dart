...
void main() {
  ...
  patrolTest('Guest drawer intercept displays prompt message on LoginScreen',
      ($) async {
    ...
    final recentGameTile =
        $(find.byKey(const Key('drawer-recent-recent_game_123')));
