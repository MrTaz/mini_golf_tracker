...
void main() {
  ...
  group('UserProvider Tests', () {
    ...
    test(
        'initialize() calls loadUserPlayers() when user is already authenticated on Firebase',
        () async {
      mockAuth = MockFirebaseAuth(
        signedIn: true,
    ...
    test(
        'authStateChanges listener calls loadUserPlayers() when loggedInUser matches firebase user',
        () async {
      final player = Player(
        id: 'user123',
        playerName: 'Test User',
    ...
    test(
        'initialize() handles loadUserPlayers() throwing exception and completes successfully',
        () async {
      final player = Player(
        id: 'user123',
        playerName: 'Test User',
    ...
    test(
        'login() handles loadUserPlayers() throwing exception and completes successfully',
        () async {
      final player = Player(
        id: 'user123',
        playerName: 'Test User',
    ...
    test(
        'authStateChanges listener handles loadUserPlayers() throwing exception and completes successfully',
        () async {
      final player = Player(
        id: 'user123',
        playerName: 'Test User',
