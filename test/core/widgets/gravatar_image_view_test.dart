...
void main() {
  ...
  testWidgets('GravatarImageView renders fading image with correct url',
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: DefaultAssetBundle(
          ...
          child: GravatarImageView(
              email: 'test@example.com', width: 100, height: 100),
        ),
      ),
    ));
  ...
  testWidgets('GravatarImageView renders with empty email',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: DefaultAssetBundle(
  ...
  testWidgets('GravatarImageView uses cache on second call',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: DefaultAssetBundle(
  ...
  testWidgets('GravatarImageView updates when email changes',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: DefaultAssetBundle(
