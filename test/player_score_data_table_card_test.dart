...
void main() {
  testWidgets('PlayerScoreDataTable renders empty state', (WidgetTester tester) async {
    final game = Game(
      id: 'g1',
      name: 'Test Game',
  ...
  testWidgets('PlayerScoreDataTable renders scores correctly', (WidgetTester tester) async {
    final course = Course(id: 'c1', name: 'Test Course', numberOfHoles: 2, parStrokes: {1: 3, 2: 4});
    final game = Game(
      id: 'g1',
      name: 'Test Game',
      course: course,
    ...
    final player1 = Player(id: 'p1', playerName: 'Alice', nickname: 'A', ownerId: 'p1', totalScore: 0);
    final player2 = Player(id: 'p2', playerName: 'Bob', nickname: 'B', ownerId: 'p2', totalScore: 0);
