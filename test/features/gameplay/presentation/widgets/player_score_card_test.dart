...
import 'package:mini_golf_tracker/features/gameplay/presentation/widgets/player_score_card.dart';

void main() {
  testWidgets('PlayerScoreCard renders correctly and handles selection',
