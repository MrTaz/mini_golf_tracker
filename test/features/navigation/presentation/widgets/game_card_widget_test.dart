...
import 'package:mini_golf_tracker/features/navigation/presentation/widgets/game_card_widget.dart';
...
void main() {
  ...
  group('GameCardWidget Tests', () {
    ...
    testWidgets('shows create new game card when no saved games exist',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('shows unstarted and started games correctly',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
    ...
    testWidgets(
        'handles different data types and corruption gracefully in deleteSavedGame',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
      ...
      final state =
          tester.state<GameCardWidgetState>(find.byType(GameCardWidget));
    ...
    testWidgets(
        'shows remote sync temporarily unavailable SnackBar if load throws error',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      final originalStore = SharedPreferencesStorePlatform.instance;
      SharedPreferencesStorePlatform.instance =
          ErrorSharedPreferencesStore(originalStore, throwOnGetAll: true);
      ...
      expect(
          find.text('Error: Unable to load saved game data'), findsOneWidget);
    ...
    testWidgets(
        'shows remote sync temporarily unavailable SnackBar if delete saved game throws error',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
      });
      ...
      final originalStore = SharedPreferencesStorePlatform.instance;
      SharedPreferencesStorePlatform.instance =
          ErrorSharedPreferencesStore(originalStore, throwOnRemove: true);
      SharedPreferences.resetStatic();
    ...
    testWidgets(
        'shows remote sync temporarily unavailable SnackBar if delete game throws on error screen',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      final originalStore = SharedPreferencesStorePlatform.instance;
      SharedPreferencesStorePlatform.instance = ErrorSharedPreferencesStore(
          originalStore,
          throwOnGetAll: true,
          throwOnRemove: true);
      SharedPreferences.resetStatic();
    ...
    testWidgets(
        'shows delete saved game SnackBar if delete game on error screen succeeds',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      final originalStore = SharedPreferencesStorePlatform.instance;
      ...
      ScaffoldMessenger.of(tester.element(find.byType(GameCardWidget)))
          .clearSnackBars();
      await tester.pump();
    ...
    testWidgets('can navigate to create game from card and pop to refresh',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('can call updateGameCard directly on the widget state',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('Start Game navigation resolves and then refreshes state',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
      });
    ...
    testWidgets('Continue Game navigation resolves and then refreshes state',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_2': jsonEncode(startedGame.toJson()),
      });
    ...
    testWidgets('Start Game navigation error triggers catchError SnackBar',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
      });
    ...
    testWidgets('Continue Game navigation error triggers catchError SnackBar',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_2': jsonEncode(startedGame.toJson()),
      });
    ...
    testWidgets(
        'Start Game and Continue Game Navigator synchronous throws trigger try/catch SnackBar',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
        'game_2': jsonEncode(startedGame.toJson()),
    ...
    testWidgets(
        'ListTile onTap routes started game to GameInprogressScreen and refreshes on pop',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_2': jsonEncode(startedGame.toJson()),
      });
    ...
    testWidgets(
        'ListTile onTap routes unstarted game to GameStartScreen and refreshes on pop',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_1': jsonEncode(unstartedGame.toJson()),
      });
    ...
    testWidgets('ListTile onTap navigation error triggers catchError SnackBar',
        (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'game_2': jsonEncode(startedGame.toJson()),
      });
