...
import 'package:mini_golf_tracker/features/navigation/presentation/widgets/past_game_card_widget.dart';
import 'package:shared_preferences/shared_preferences.dart';

void main() {
  testWidgets('PastGameCardWidget shows waiting then no games',
      (WidgetTester tester) async {
    SharedPreferences.setMockInitialValues({});
    await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: PastGameCardWidget())));
  ...
  testWidgets('PastGameCardWidget shows games list and handles tap',
      (WidgetTester tester) async {
  ...
  testWidgets('PastGameCardWidget handles error', (WidgetTester tester) async {
    ...
    completer.future.catchError(
        (_) => <Game?>[]); // Prevent unhandled exception in test zone
  ...
  testWidgets('PastGameCardWidget updates when gamesFuture changes',
      (WidgetTester tester) async {
