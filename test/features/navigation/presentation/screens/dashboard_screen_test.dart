...
void main() {
  ...
  testWidgets('renders BottomNavigationBar for logged-in users',
      (tester) async {
    final player = Player(
      id: 'p123',
  ...
  testWidgets('does not render BottomNavigationBar for guest users',
      (tester) async {
  ...
  testWidgets('supports navigation and tapping Friends card', (tester) async {
    ...
    expect(
        find.byWidgetPredicate(
            (w) => w.runtimeType.toString() == 'PastGamesScreen'),
        findsOneWidget);
    ...
    expect(
        find.byWidgetPredicate(
            (w) => w.runtimeType.toString() == 'CoursesScreen'),
        findsOneWidget);
    ...
    expect(
        find.byWidgetPredicate(
            (w) => w.runtimeType.toString() == 'DashBoardLayout'),
        findsOneWidget);
  });
}
