...
void main() {
  ...
  testWidgets(
      'Schedule: shows scheduling conflict dialog and cancel stops schedule',
      (tester) async {
    tester.view.physicalSize = const Size(800, 1600);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    ...
    final conflictGame = Game(
      ...
      players: [
        PlayerGameInfo(
            playerId: 'auth-uid', gameId: 'conflict_game', scores: [])
      ],
    ...
    await tester.pumpWidget(_testApp(
      home: Scaffold(
        body: GameStartScreen(
            unstartedGame: _twoPlayerGame(scheduledTime: DateTime.now())),
      ),
    ));
  ...
  testWidgets(
      'Schedule: shows scheduling conflict dialog and double-book schedules game',
      (tester) async {
    tester.view.physicalSize = const Size(800, 1600);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    ...
    final conflictGame = Game(
      ...
      players: [
        PlayerGameInfo(
            playerId: 'auth-uid', gameId: 'conflict_game2', scores: [])
      ],
      scheduledTime: DateTime.now().add(const Duration(minutes: 30)),
      status: 'unstarted_game',
    );
  ...
  testWidgets(
      'Start: shows warning dialog when active game exists and cancel stops start',
      (tester) async {
    tester.view.physicalSize = const Size(800, 1600);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    ...
    SharedPreferences.setMockInitialValues(
        {'active_game': jsonEncode(game.toJson())});
  ...
  testWidgets(
      'Start: shows warning dialog when active game exists and continue starts game',
      (tester) async {
    tester.view.physicalSize = const Size(800, 1600);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
