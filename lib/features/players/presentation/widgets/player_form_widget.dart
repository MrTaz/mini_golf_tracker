...
class PlayerFormState extends State<PlayerForm> {
  ...
  bool validateRequiredFields() {
    ...
    final playerNameMissing = !isGuestScorekeeper &&
        !isImplicitQuickPlay &&
  ...
  Future<void> checkDuplicate() async {
    ...
    if (normalizedEmail != null || normalizedPhone != null) {
      bool localCollision = allPlayers.any((player) {
        ...
        final playerNormEmail = player.normalizedEmail ??
            ContactIdentity.normalizeEmail(player.email);
        final playerNormPhone = player.normalizedPhoneNumber ??
            ContactIdentity.normalizePhoneNumber(player.phoneNumber);

        final emailMatch =
            normalizedEmail != null && playerNormEmail == normalizedEmail;
        final phoneMatch =
            normalizedPhone != null && playerNormPhone == normalizedPhone;
